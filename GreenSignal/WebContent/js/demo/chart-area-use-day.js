			...
			var myLineChart = new Chart(ctx, {
			  ...
			  data: {
			    ...
			    datasets: [{
			      ...
			      pointHitRadius: 10,
			      pointBorderWidth: 2,
			      data: [77.5, 71.7, 73.2, 72.8, 82.3, 84.5, 70.5, 72.4, 69.5, 71.4, 70.3, 82.6, 83.5, 73.2, 74.1, 70.6, 71.3, 72.1, 81.5, 79.6, 69.3, 
			    	  73.1, 72.9, 70.4, 71.6, 84.7, 82.5, 69.3, 73.6, 71.2],
			    }],
			  },
			  options: {
